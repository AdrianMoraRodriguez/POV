...
public class Window : GameWindow
{
  ...
  protected override void OnLoad()
  {
    ...
    GL.VertexAttribPointer(posLocation, 3, VertexAttribPointerType.Float, false, 7 * sizeof(float), 0); // (Localización del atributo (de manera física en la memoria), tamaño del atributo, tipo de dato, normalizado o no, stride (espacio entre vértices), offset (desplazamiento dentro del vértice))
  ...
  protected override void OnRenderFrame(FrameEventArgs args)
  {
    ...
    // Dibujo de la figura
    GL.DrawElements(PrimitiveType.Triangles, 36, DrawElementsType.UnsignedInt, indexData);  // (Tipo de primitiva, número de índices, tipo de los índices, array de índices)
